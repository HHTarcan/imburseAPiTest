...
public class CreateHMAC {
    ...
    public CreateHMAC() throws NoSuchAlgorithmException {
        ...
        publicKey = ConfigurationReader.get("PublicKey");
        privateKey = ConfigurationReader.get("PrivateKey");
